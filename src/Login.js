...
export default function Login() {
    ...
    const postData = (e) => {
        e.preventDefault();
        fetch(`${process.env.REACT_APP_BACKEND_URL}/api/auth/signin`, { //Making post request to server for logging the user
            method: 'POST',
            ...
            .then((data) => {
                if (data.statusCode === 200 && data.token) {
                    ...
                    navigate("/home")//If user is valid then redirecting to home page
